...
const RegisterPage = () => {
    ...
    return (
        <div className="dark min-h-screen flex flex-col items-center justify-start bg-[url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center bg-no-repeat bg-blend-overlay bg-black/80 py-12 px-4 relative">
