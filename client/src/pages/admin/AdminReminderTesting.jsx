              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <CustomDropdown
                    ...
                    buttonClassName="!rounded-lg !text-xs !py-2 !px-3 !bg-surface-primary hover:!bg-surface-secondary !font-normal h-[34px] border-border"
                    menuClassName="!bg-surface-primary !border-border !rounded-lg !w-full !max-w-none text-xs"
                  />
                </div>
                <div>
                    ...
                    {isClientDropdownOpen && selectedGym && !loadingClients && (
                      <div className="absolute right-0 left-0 mt-1.5 bg-surface-primary border border-border rounded-xl shadow-xl z-30 p-3 space-y-2 flex flex-col max-h-72">
                        ...
                        <div className="overflow-y-auto divide-y divide-border/30 flex-1 custom-scrollbar text-xs">
                          {/* Option: All Clients */}
                          <label className="flex items-center gap-2.5 py-2 px-2 hover:bg-primary hover:text-black rounded cursor-pointer font-bold text-text-primary transition-colors duration-150 group">
                            <input
                              type="checkbox"
                              ...
                              className="rounded border-border text-primary focus:ring-primary h-3.5 w-3.5 bg-surface-primary accent-primary cursor-pointer"
                          ...
                          {filteredClients.length > 0 ? (
                            filteredClients.map(client => {
                              ...
                              return (
                                <label key={client._id} className="flex items-center gap-2.5 py-2 px-2 hover:bg-primary hover:text-black rounded cursor-pointer text-text-secondary transition-colors duration-150 group">
                                  <input
                                    type="checkbox"
                                    ...
                                    style={{ accentColor: 'var(--color-accent)' }}
                                  />
                                  <span className="font-mono text-[9px] bg-surface-divider group-hover:bg-black/10 group-hover:text-black px-1.5 py-0.5 rounded text-text-primary font-bold tracking-wider shrink-0 transition-colors duration-150">
                                    {client.clientId || 'N/A'}
                                  </span>
                                  <span className="truncate group-hover:text-black font-semibold transition-colors duration-150">{client.personalInfo?.name}</span>
                                </label>
                              );
                            })
                          ) : (
