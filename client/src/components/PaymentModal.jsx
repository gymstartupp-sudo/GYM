...
//                                         <div className="w-full bg-surface-divider/80 border border-border rounded-xl p-3 text-emerald-400 bg-surface-primary font-bold flex items-center justify-between">
